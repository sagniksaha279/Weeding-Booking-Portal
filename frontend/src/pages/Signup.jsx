...
export default function Signup() {
  ...
  const getPasswordStrength = (pwd) => {
    ...
    if (/^(.)\1+$/.test(pwd)) {
      return { label: "Invalid", color: "#ef4444", width: "20%" };
    }
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #FDF8F3 0%, #F5EFE8 50%, #FDF8F3 100%)",
      }}
    >
      {/* Animated background */}
      ...
      >
        <div
          className="bg-white/90 backdrop-blur-xl border border-[rgba(139,111,71,0.12)] shadow-[0_24px_80px_rgba(74,55,40,0.12)]"
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "'Jost', sans-serif", color: "#7A6555" }}
            >
        ...
        >
          ...
          />
          <div
            className="w-1.5 h-1.5 bg-[rgba(201,169,110,0.4)]"
            style={{ transform: "rotate(45deg)" }}
          />
          <span
            style={{
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(270deg, transparent, rgba(201,169,110,0.3))",
            }}
          />
        </motion.div>
      </motion.div>
